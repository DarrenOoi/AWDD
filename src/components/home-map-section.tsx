...
const MAP_HEIGHT = "h-[min(440px,62vh)] sm:h-[480px]";
      ...
      <div className="flex flex-col gap-4 border-b border-stone-200/80 pb-6 sm:flex-row sm:items-end sm:justify-between">
        <div>
          ...
          <p className="mt-2 max-w-xl text-stone-600">
            Pan and zoom with Google Maps — tap a pin for a quick preview, or browse dealers for filters and list
            view.
          </p>
        </div>
        <Link
